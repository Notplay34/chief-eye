...
> Сохраняется как релизный контекст прошлых итераций и не является основной документацией проекта.
...
- [x] На сервере: смена пароля стартового администратора после первого входа (инструкция в INSTALL).
...
| 2 | **Проверить сайт:** вход под стартовым администратором из `.env`, форма заказа, «Принять наличные», павильон 2, админка. |
