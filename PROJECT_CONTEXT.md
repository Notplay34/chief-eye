...
> Главный документ бизнес-логики проекта.
> Исторические планы, аудиты и дневники разработки не заменяют этот файл.

**Главный документ архитектуры и логики проекта.**
При проектировании и написании кода нужно ориентироваться прежде всего на этот файл и на актуальный код.
