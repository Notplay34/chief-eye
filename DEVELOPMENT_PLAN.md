...
> Содержит ранний план проекта и не отражает текущее состояние репозитория.
> Актуальная навигация по документации: `README.md`, `PROJECT_CONTEXT.md`, `INSTALL.md`, `USER_GUIDE.md`, `DEPLOYMENT.md`.
